...
export const HomePage: React.FC = () => {
  ...
  const { topMusic, mostPlayedMusic } = useAppSelector((state) => state.music);
    ...
    <div className="w-[90%] m-auto p-4">
      ...
      <div className="mt-16">
        <div className="flex justify-between items-center">
          ...
          <button
            className="text-sm flex items-center text-blue-300"
      ...
      <div className="mt-16">
        <div className="flex justify-between items-center">
          ...
          <button
            className="text-sm flex items-center text-green-300"
